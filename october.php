...
<div class="h1"><h1>October's Project List</h1><div>
...
<div class="datatable">
	...
	$query = "SELECT * FROM january WHERE startdate AND enddate between  '2018-10-01' AND '2018-10-31'";
	...
	<table border="1">
		...
		<tr>
		    ...
		    <?php echo "<td><a href=october.php?delid=".$row['id'].">Delete</a></td>"; ?>
