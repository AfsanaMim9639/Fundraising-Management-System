...
<div class="h1"><h1>August's Project List</h1><div>
...
<div class="datatable">
	...
	$query = "SELECT * FROM january WHERE startdate AND enddate between  '2018-08-01' AND '2018-08-31'";
	...
	<table border="1">
		...
		<tr>
		    ...
		    <?php echo "<td><a href=august.php?delid=".$row['id'].">Delete</a></td>"; ?>
