...
<div class="h1"><h1>February's Project List</h1><div>
...
<div class="datatable">
	...
	$query = "SELECT * FROM january WHERE startdate AND enddate between  '2018-02-01' AND '2018-02-31'";
	...
	<table border="1">
		...
		<tr>
		    ...
		    <?php echo "<td><a href=february.php?delid=".$row['id'].">Delete</a></td>"; ?>
