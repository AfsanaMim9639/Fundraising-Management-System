...
<div class="h1"><h1>July's Project List</h1><div>
...
<div class="datatable">
	...
	$query = "SELECT * FROM january WHERE startdate AND enddate between  '2018-07-01' AND '2018-07-31'";
	...
	<table border="1">
		...
		<tr>
		    ...
		    <?php echo "<td><a href=july.php?delid=".$row['id'].">Delete</a></td>"; ?>
