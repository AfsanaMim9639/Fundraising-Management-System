...
<div class="h1"><h1>March's Project List</h1><div>
...
<div class="datatable">
	...
	$query = "SELECT * FROM january WHERE startdate AND enddate between  '2018-03-01' AND '2018-03-31'";
	...
	<table border="1">
		...
		<tr>
		    ...
		    <?php echo "<td><a href=march.php?delid=".$row['id'].">Delete</a></td>"; ?>
