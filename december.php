...
<div class="h1"><h1>December's Project List</h1><div>
...
<div class="datatable">
	...
	$query = "SELECT * FROM january WHERE startdate AND enddate between  '2018-12-01' AND '2018-12-31'";
	...
	<table border="1">
		...
		<tr>
		    ...
		    <?php echo "<td><a href=december.php?delid=".$row['id'].">Delete</a></td>"; ?>
