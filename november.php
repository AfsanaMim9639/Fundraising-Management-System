...
<div class="h1"><h1>November's Project List</h1><div>
...
<div class="datatable">
	...
	$query = "SELECT * FROM january WHERE startdate AND enddate between  '2018-11-01' AND '2018-11-31'";
	...
	<table border="1">
		...
		<tr>
		    ...
		    <?php echo "<td><a href=november.php?delid=".$row['id'].">Delete</a></td>"; ?>
